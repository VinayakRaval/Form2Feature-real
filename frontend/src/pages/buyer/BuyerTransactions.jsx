            ...
            >
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-2">
                        Track your crop purchase transactions and payments.
                    </p>
                ...
                <div className="bg-white border rounded-2xl p-7">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">
                                Your crop purchase transactions will appear here.
                            </p>
                    ...
                    <div className="border-2 border-dashed rounded-2xl p-12 text-center">
                        ...
                        <p className="text-gray-500 mt-2">
                            You don't have any crop purchase transactions yet.
                        </p>

                        <p className="text-gray-500">
                            Accepted deals and completed purchases will appear here.
                        </p>
